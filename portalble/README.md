...
- **Python**: Wersja [Python 3.14](https://www.python.org/) portable, redystrubucja binarek (dot) z [WinPython](https://winpython.github.io/), z doinstalowanymi pakietami `asyncpg`, `dotenv`, `request`
